              ...
              {navTeam && (
                <button
                  onMouseDown={(e) => {
                    e.stopPropagation();
                    setProfileOpen(false);
                    router.push(`/teams/${navTeam.id}/billing`);
                  }}
                  className="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors flex items-center gap-2 cursor-pointer"
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
