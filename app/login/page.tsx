    ...
    <div className="min-h-screen flex">
        ...
        <div className="relative z-10 flex flex-col justify-between p-16 xl:p-20 w-full">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-3 group">
              <img src="/images/amber_teal-logo.png" alt="AutoMyReply" className="h-10 w-auto" />
              <span className="text-xl font-bold text-white tracking-tight">AutoMyReply</span>
            </Link>
          </div>
          ...
          <div className="max-w-md">
            <h2 className="text-4xl xl:text-[2.75rem] font-extrabold text-white leading-[1.15] mb-5 tracking-tight">
              ...
              <span className="block mt-1 text-amber-400">growth opportunity</span>
            </h2>
              ...
              {[
                ...
                <div key={i} className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-white/[0.06] border border-white/[0.08] flex items-center justify-center flex-shrink-0">
                    <svg className="w-5 h-5 text-amber-400/80" fill="none" stroke="currentColor" viewBox="0 0 24 24">{feature.icon}</svg>
                  </div>
                  <div>
                    <div className="font-semibold text-white/90 text-[15px]">{feature.title}</div>
                    <div className="text-teal-300/50 text-sm mt-1">{feature.desc}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="max-w-md">
            <div className="bg-white/[0.04] backdrop-blur-sm rounded-2xl p-6 border border-white/[0.06]">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-white/80 text-sm font-medium">Rachel Torres</div>
                  <div className="text-teal-400/40 text-xs">Operations Manager, Peak Fitness</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="w-full lg:w-1/2 flex flex-col min-h-screen bg-gray-50">
          ...
          <div className="w-full max-w-[380px]">
            ...
            <div className="mb-12">
              <div className="hidden lg:block mb-8">
                <img src="/images/amber_teal-logo.png" alt="AutoMyReply" className="h-11 w-auto" />
              </div>
              <h1 className="text-3xl font-bold text-gray-900 tracking-tight mb-3">Welcome back</h1>
              <p className="text-gray-500 text-[15px] leading-relaxed">Sign in to manage your reviews and grow your business.</p>
            </div>
            ...
            <div className="relative my-10">
              ...
              <div className="relative flex justify-center">
                <span className="bg-gray-50 px-4 text-[11px] text-gray-400 uppercase tracking-widest font-medium">secure sign-in</span>
              </div>
            </div>
            ...
            <div className="space-y-5 mb-10">
              {[
                { text: 'No password needed — Google handles authentication', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /> },
                { text: 'Your data is encrypted and never shared', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /> },
                { text: 'Free plan available — no credit card required', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> },
              ].map((item, i) => (
                <div key={i} className="flex items-center gap-3.5">
                  <div className="w-9 h-9 rounded-lg bg-teal-50 flex items-center justify-center flex-shrink-0">
                    <svg className="w-[18px] h-[18px] text-teal-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">{item.icon}</svg>
                  </div>
                  <span className="text-[13px] text-gray-500 leading-snug">{item.text}</span>
                </div>
              ))}
            </div>
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              ...
              <Link href="/terms" className="text-teal-600 hover:text-teal-700 underline underline-offset-2 decoration-teal-600/30">Terms of Service</Link>
              {' '}and{' '}
              <Link href="/privacy" className="text-teal-600 hover:text-teal-700 underline underline-offset-2 decoration-teal-600/30">Privacy Policy</Link>.
            </p>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center justify-center pb-10">
          <Link href="/" className="group inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-teal-600 transition-colors">
