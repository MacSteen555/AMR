            ...
            <div className="p-8 h-screen flex flex-col">
                ...
                <div className="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p className="text-gray-500 mt-0.5">Manage customer feedback for this location.</p>
                    </div>
                    <div className="flex gap-2">
                        <button onClick={handleSync} disabled={isSyncing || canPostReplies === false}
                        ...
                        <button onClick={handleBulkPublish} disabled={isPublishing || canPostReplies === false}
                                        ...
                                        <div className="flex justify-between items-start">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="text-xs text-gray-400 mt-0.5">{new Date(review.review_date).toLocaleDateString()}</div>
                                                </div>
                                            </div>
                                            <div className="flex items-center gap-2">
                                                            ...
                                                            <div className="flex gap-2">
                                                                ...
                                                                {review.reply_status !== 'posted' ? (
                                                                    <button onClick={() => handlePublish(review.id, edits[review.id])}
                                                                        disabled={!!publishingId || canPostReplies === false}
                                ...
                                <div className="w-full max-w-3xl bg-white rounded-2xl shadow-xl border border-gray-200 transition-all duration-300">
                                    <div className="p-8">
                                        ...
                                        <div className="bg-gray-50 rounded-xl border border-gray-200 p-5 mb-6 min-h-[180px] flex flex-col">
                                            ...
                                            {(currentStackReview.reply_status === 'draft' || isStreaming(currentStackReview.id)) ? (
                                                <textarea
                                                    className={`flex-1 w-full bg-white p-4 border border-gray-200 rounded-lg text-gray-800 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 resize-none ${isStreaming(currentStackReview.id) ? '' : ''}`}
                                                    rows={5}
